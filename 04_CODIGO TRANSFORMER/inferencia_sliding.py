...
class MotorInferenciaMixta:
    ...
    def procesar_mixto(self, paths: List[Path]) -> Tuple[np.ndarray, np.ndarray]:
        ...
        # UNIMOS REPOSO Y MARCHA EN UNA SOLA SECUENCIA
        ...
        # 2 VENTANA DESLIZANTE SOBRE TODA LA UNION
    ...
    def reporte_transicion(self, tiempos: np.ndarray, probabilidades: np.ndarray):
        ...
        for i, (t, p) in enumerate(zip(tiempos, probabilidades)):
            # SOLO IMPRIMIMOS ALGUNOS PUNTOS PARA NO COLAPSAR LA CONSOLA
            ...
            # Imprimir cada 4 ventanas o si hay cambio
            if i % 4 == 0 or aviso != "":
...
if __name__ == "__main__":
    ...
    # ELEGIMOS DOS ARCHIVOS PARA PEGARLOS
    # Primero reposo (0), luego marcha (1)
